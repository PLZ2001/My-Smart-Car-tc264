...
public class SerialPortManager : MonoBehaviour
{
    ...
    public int receiveLength = (4+187*40+4 + 4+1+4 + 4+4+4 + 4+5+4 + 4+1+4 +4+6+4 + 4+6+4 +4+1+4 + 4+512+4) * 2;//指定sb的字符串长度，等于所有命令长度的2倍时最好 
    public int baseReceiveLength = (4 + 187 * 40 + 4 + 4 + 1 + 4 + 4 + 4 + 4 + 4 + 5 + 4 + 4 + 1 + 4 + 4 + 6 + 4 + 4 + 6 + 4 + 4 + 1 + 4 + 4 + 512 + 4) * 2;
