...
void Differential_Motor(void)
{
    if (steering_Error>=0)
    {
        speed_Target2 = speed_Target + Differential_Ratio*steering_Error/1062.5f;//左轮目标速度（m/s）
        speed_Target1 = speed_Target - InnerSide_Ratio*Differential_Ratio*steering_Error/1062.5f;
...
//        speed_Target1 = speed_Target - 0.9*steering_Error/600*(speed_Target+Differential_Ratio)/(1.2f+1);
    ...
    {
        speed_Target1 = speed_Target - Differential_Ratio*steering_Error/1062.5f;//右轮目标速度（m/s）
        speed_Target2 = speed_Target + InnerSide_Ratio*Differential_Ratio*steering_Error/1062.5f;
