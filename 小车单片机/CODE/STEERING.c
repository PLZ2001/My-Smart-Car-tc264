...
uint32 STEERING_DUTY_CENTER=771;//765;//;773;//765;//779;//781;//755;//775;//765;//777;//671;//667;//661;//669;//643;//652;//646;//667;//639;//653;//644;//646;//664;//652;//665;//647;//1500;//1772;
...
//    if(steering_Target<STEERING_MIN) steering_Target = STEERING_MIN;
    if(steering_Target>STEERING_MAX+5) steering_Target = STEERING_MAX+5;
    if(steering_Target<STEERING_MIN-5) steering_Target = STEERING_MIN-5;
}
