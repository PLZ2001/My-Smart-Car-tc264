    ...
    if (OLED_EN == TRUE)
    {
        ...
        switch(OLED_Page)
        {
           ...
           case Circle_Page:
               ...
               OLED_PRINTF(0,2,"R_max_d:%02.02f    ",max_d_Right);
               OLED_PRINTF(0,3,"R_min_d:%02.02f    ",min_d_Right);
               OLED_PRINTF(0,4,"R_ave_dd:%02.02f    ",dd_Right_Ave);
               OLED_PRINTF(0,5,"L_max_d:%02.02f    ",max_d_Left);
               OLED_PRINTF(0,6,"L_min_d:%02.02f    ",min_d_Left);
               OLED_PRINTF(0,7,"L_ave_dd:%02.02f    ",dd_Left_Ave);
               break;
