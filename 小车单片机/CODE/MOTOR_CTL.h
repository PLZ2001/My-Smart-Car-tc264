...
extern float OuterSide_Ratio;
extern float OuterSide_Ratio_Highest;
extern float OuterSide_Ratio_High;
extern float OuterSide_Ratio_Low;
extern float OuterSide_Ratio_Lowest;
extern float OuterSide_Ratio_Lowest_ForT;
